...
CREATE TABLE IF NOT EXISTS trip_photos (
    ...
    trip_id BIGINT UNSIGNED NOT NULL COMMENT '关联行程ID（确定图片归属的行程）',
    trip_item_id BIGINT UNSIGNED COMMENT '关联行程项ID（可选，如“故宫游览”行程项的照片，可为空）',
    place_id BIGINT UNSIGNED COMMENT '关联地点ID（可选，如“故宫博物院”地点的照片，可为空）',
    ...
    uploader_id BIGINT UNSIGNED NOT NULL COMMENT '上传者用户ID（用于多人协作时追踪图片归属）',
